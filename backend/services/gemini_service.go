...
1. เกณฑ์หลัก (Main Criterion) **ต้องแบ่งเป็นหัวข้อเดี่ยวๆ ชัดเจน ห้ามรวบรวม 2 หัวข้อเข้าด้วยกัน**
2. แต่ละเกณฑ์หลัก **ต้องมีเกณฑ์ย่อย (Sub-criteria) จำนวน 3 ข้อถ้วนเสมอ** (ประกอบด้วย ระดับดี, ระดับปานกลาง, ระดับแย่)
